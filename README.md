...
```
cd existing_repo
git remote add origin https://gitlab.com/cyberxit/dashboardx-automation-test.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cyberxit/dashboardx-automation-test/-/settings/integrations)
